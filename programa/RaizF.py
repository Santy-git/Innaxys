...
# ..................................................
    def ej(self):
        self.raizes.bgcolor = '#4a624e'
        self.raizes.update()

    def OFF(self, e):
        global idioma
        self.raizes.window_destroy()
        idioma = 3
    ...
    def appbar(self):
        ...
        self.raizes.appbar = ft.AppBar(
            title=self.nombre,
            center_title=True,
            bgcolor=colores[8],
            actions=[
                ft.IconButton(ft.icons.LANGUAGE,
                              on_click=self.EsEn, icon_size=35),
                ft.IconButton(ft.icons.EXIT_TO_APP_ROUNDED,
                              on_click=self.OFF, icon_size=35,),
            ]
    ...
    def login_menu(self):
        ...
        if z[2] == 3:
            ...
            self.raizes.add(self.contenedor_login)
...
while True:
    ...
    if idioma == 2:    
        ...
        def main(raizes: ft.Page):
            global altura
            global ancho
            altura = raizes.window_height
            ancho = raizes.window_width
            print(altura, ancho)
            raizes.window_resizable = False
            raizes.window_full_screen = True
            raizes.update()
            objeto = EsPlantilla(raizes)
            objeto.ej()
            z = objeto.appbar()
            objeto.login_menu()
        ft.app(target=main)
